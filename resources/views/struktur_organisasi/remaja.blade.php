@extends('layouts.app')
@section('title', 'Struktur Organisasi Remaja Mesjid')
@section('content')
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Struktur Organisasi Remaja Mesjid {{ mosqueName() }}</strong>
                        </div>
                        <div class="card-body">
                            <h4>SUSUNAN PENGURUS Remaja Mesjid {{ strtoupper(mosqueName()) }}</h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        ...
                        <h4 class="modal-title-insert">Update Struktur Organisasi Remaja Mesjid</h4>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: '{{ route('struktur.show_remaja') }}',
                type: 'GET',
                dataType: 'JSON',
