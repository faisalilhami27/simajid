@extends('layouts.app')
@section('title', 'Struktur Organisasi DKM')
@section('content')
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Struktur Organisasi DKM {{ mosqueName() }}</strong>
                        </div>
                        <div class="card-body">
                            <h4>SUSUNAN PENGURUS DKM {{ strtoupper(mosqueName()) }}</h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        ...
                        <h4 class="modal-title-insert">Update Struktur Organisasi DKM</h4>
                    </div>
