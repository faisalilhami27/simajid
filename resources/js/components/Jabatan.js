...
export default class Jabatan extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: 0,
    ...
    handleEdit(id) {
        ...
        axios({
            ...
            if (res.data.status == 200) {
                ...
                self.$tl.html("Update Data Jabatan");
            } else {
    ...
    openModal() {
        ...
        this.$tl = $(this.tl);
        this.$tl.html("Tambah Data Jabatan");
    }
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header bg-primary">
                                ...
                                <h4 className="modal-title-insert" ref={tl => this.tl = tl}>Tambah Data Jabatan</h4>
                            </div>
...
if (document.getElementById('jabatan')) {
    ReactDOM.render(<Jabatan/>, document.getElementById('jabatan'));
}
