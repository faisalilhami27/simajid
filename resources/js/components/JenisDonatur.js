...
export default class JenisDonatur extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: 0,
            ...
            buttons: {
                ...
                ok: {
                    ...
                    action: function () {
                        axios({
                            method: 'delete',
                            url: ROUTE + 'jenis_donatur/delete',
                            data: {
                                id: id
                            },
                            dataType: 'json',
    ...
    handleSubmit(e) {
        ...
        if (this.state.edit === false) {
            axios({
                method: 'post',
                url: ROUTE + 'jenis_donatur/insert',
                data: sendData,
                dataType: 'JSON',
                config: {headers: {'Content-Type': 'multipart/form-data'}}
            })
            ...
            axios({
                method: 'put',
                url: ROUTE + 'jenis_donatur/update',
                data: sendData + '&id=' + id,
                dataType: 'JSON',
                config: {headers: {'Content-Type': 'multipart/form-data'}}
            })
                        ...
                        <div className="col-xs-12">
                            <div className="card">
                                <div className="card-header">
                                    <strong>Daftar Jenis Donatur</strong>
                                </div>
...
if (document.getElementById('jenis_donatur')) {
    ReactDOM.render(<JenisDonatur/>, document.getElementById('jenis_donatur'));
}
