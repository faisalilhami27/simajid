...
export default class JenisPengeluaran extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: 0,
            ...
            buttons: {
                ...
                ok: {
                    ...
                    action: function () {
                        axios({
                            method: 'delete',
                            url: ROUTE + 'jenis_pengeluaran/delete',
                            data: {
                                id: id
                            },
                            dataType: 'json',
    ...
    handleSubmit(e) {
        ...
        if (this.state.edit === false) {
            axios({
                method: 'post',
                url: ROUTE + 'jenis_pengeluaran/insert',
                data: sendData,
                dataType: 'JSON',
                config: {headers: {'Content-Type': 'multipart/form-data'}}
            })
            ...
            axios({
                method: 'put',
                url: ROUTE + 'jenis_pengeluaran/update',
                data: sendData + '&id=' + id,
                dataType: 'JSON',
                config: {headers: {'Content-Type': 'multipart/form-data'}}
            })
    ...
    handleEdit(id) {
        ...
        axios({
            method: 'post',
            url: ROUTE + 'jenis_pengeluaran/get',
            data: "id=" + id,
            dataType: 'json',
            config: {headers: {'Content-Type': 'multipart/form-data'}}
        }).then(function (res) {
    ...
    componentDidMount() {
        ...
        this.$el.DataTable({
            ...
            ajax: {
                "url": ROUTE + 'jenis_pengeluaran/json',
                "type": "POST",
                "headers": {
...
if (document.getElementById('jenis_pengeluaran')) {
    ReactDOM.render(<JenisPengeluaran/>, document.getElementById('jenis_pengeluaran'));
}
